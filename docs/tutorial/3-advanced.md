...
size. Here, we used it to add 1.2x of the font size as spacing. Now, let's add the
abstract. Remember that the conference wants the abstract to be set ragged and
centered.
